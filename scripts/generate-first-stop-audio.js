...
async function generateFirstStopAudio() {
  try {
    ...
    console.log('Generating audio for NEMO Science Museum with full content...');
    ...
    const fileName = `stop${stopData.orderNumber}.mp3`;
