...
async function generateStopAudio() {
  try {
    // Sample text for NEMO Science Museum
    const stopData = {
      id: 1,
      orderNumber: 1,
    ...
    console.log('Generating audio for NEMO Science Museum...');
    ...
    const fileName = `stop${stopData.orderNumber}_${stopData.title.toLowerCase().replace(/\s+/g, '_')}.mp3`;
