...
async function generateStop7Part5Audio() {
  try {
    console.log('Generating audio for Stop 7 (Part 5 - Kids Content)...');
    
    // Kids content for Stop 7
    ...
    // Create filename
    const fileName = `stop7_part5.mp3`;
